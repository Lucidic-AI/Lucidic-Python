...
class SessionResource:
    ...
    async def acreate_session(self, params: Dict[str, Any]) -> Dict[str, Any]:
        """Create a new session (asynchronous).
        ...
        Returns:
            Created session data with session_id
        """
        return await self.http.apost("initsession", params)
    
    async def aget_session(self, session_id: str) -> Dict[str, Any]:
    ...
    async def aupdate_session(self, session_id: str, updates: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Add session_id to the updates payload
        updates["session_id"] = session_id
        return await self.http.aput("updatesession", updates)
    ...
    async def aend_session(
        ...
        return await self.aupdate_session(session_id, updates)
